...
class Reimbursement(Base):
    ...
    files = relationship("ReimbursementFile", back_populates="reimbursement", cascade="all, delete-orphan", passive_deletes=True, order_by="ReimbursementFile.sort_order")
